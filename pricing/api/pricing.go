// Package api provides domain types and facades for cloud provider instance details and their pricing.
package api
...
type GetProviderInstancePricingAccessFunc func(provider apicommon.CloudProvider, instanceTypeInfoPath string) (InstancePricingAccess, error)
