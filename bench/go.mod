module github.com/gardener/scaling-advisor/bench
...
require (
	...
	// Minimum supported karpenter version is v1.9.0 to support
	// labels using 'kubernetes.io' domain
	// Ref: https://github.com/kubernetes-sigs/karpenter/pull/2586
