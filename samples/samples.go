...
// LoadClusterConstraints loads cluster constraints from the testdata filesystem.
...
// LoadClusterSnapshot loads a cluster snapshot from the testdata filesystem.
...
// LoadBinPackingSchedulerConfig loads the kube-scheduler configuration from the testdata filesystem.
