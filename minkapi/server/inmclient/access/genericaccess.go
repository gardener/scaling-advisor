...
func (a *GenericResourceAccess[T, L]) CreateObject(_ context.Context, _ metav1.CreateOptions, inputObj T) (storedObj T, err error) {
	o, err := a.View.CreateObject(a.GVK, inputObj)
	if err != nil {
		return
	}
...
func (a *GenericResourceAccess[T, L]) CreateObjectWithAccessNamespace(_ context.Context, _ metav1.CreateOptions, inputObj T) (storedObj T, err error) {
...
func (a *GenericResourceAccess[T, L]) DeleteObject(_ context.Context, namespace, name string, _ metav1.DeleteOptions) error {
...
func (a *GenericResourceAccess[T, L]) GetObject(_ context.Context, namespace, name string, opts metav1.GetOptions) (targetObj T, err error) {
...
func (a *GenericResourceAccess[T, L]) GetObjectList(ctx context.Context, namespace string, opts metav1.ListOptions) (listObj L, err error) {
	...
	lobj, err := a.View.ListObjects(a.GVK, c)
	if err != nil {
		return
	}
...
func (a *GenericResourceAccess[T, L]) PatchObjectStatus(_ context.Context, name string, patchData []byte) (patchedObj T, err error) {
