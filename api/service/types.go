...
type ScalingAdviceResponse struct {
	...
	// This is only set by the scaling advisor service if ScalingAdviceRequest.DiagnosticVerbosity is set to true.
...
// SimulatorConfig holds the configuration for the internal simulator used by the scaling advisor service.
...
type ScalingAdvisorServiceConfig struct {
	...
	// TraceLogBaseDir is the base directory for storing trace log files used by the scaling advisor service.
	TraceLogBaseDir string
	// ServerConfig holds the server configuration for the scaling advisor service.
	...
	// ClientConfig holds the client QPS and Burst settings for the scaling advisor service.
