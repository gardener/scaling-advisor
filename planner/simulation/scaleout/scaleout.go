...
func (s *defaulSimulation) ActivityStatus() plannerapi.ActivityStatus {
...
func (s *defaulSimulation) doWork(ctx context.Context, view minkapi.View) error {
	log := logr.FromContextOrDiscard(ctx)
	log.V(5).Info("Invoked doWork", "viewName", view.GetName())
...
//func (s *defaulSimulation) getScaledNodePlacementInfo() sacorev1alpha1.NodePlacement {
//	return sacorev1alpha1.NodePlacement{
//		PoolName:         s.args.NodePool.Name,
//		TemplateName:     s.nodeTemplate.Name,
